...
class AlexNet:
    ...
    def classifier(self, x, num_class, drop_rate, compression, name):
        """
        ...
        # Dense_1
        if drop_rate:
            x = layers.Dropout(rate=drop_rate, name="dropout_1")(x)
        x = layers.Dense(
            units=dense_unit,
            use_bias=False,
            kernel_initializer="HeNormal",
        ...
        # Dense_2
        if drop_rate:
            x = layers.Dropout(rate=drop_rate, name="dropout_2")(x)
        x = layers.Dense(
            units=dense_unit / 2,
            use_bias=False,
            kernel_initializer="HeNormal",
    ...
    def _build(self, input_shape, num_class, num_filter, drop_rate, compression):
        """
        AlexNet Build
        ...
        Args:
         ...
         drop_rate: Classifier drop_rate 조절
        ...
        output = self.classifier(
            x, num_class, drop_rate, compression, name="classifier"
        )
